...
void wifi_attack_cycle_profile(void);   // cycle attack profile in picker
void wifi_attack_start(void);           // start attack with current profile
...
const char  *wifi_attack_get_profile(void);
